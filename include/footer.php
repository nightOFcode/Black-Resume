...
<div class="container color-background rounded-top dark-mode">
    ...
    <footer class="p-4 d-flex justify-content-between">
        ...
        <div class="d-flex">
            ...
            <a href="#" class="pe-md-3 pe-2 footer-text footer-link" data-bs-toggle="tooltip" data-bs-placement="top" title="My Discord">
                <i class="bi bi-discord"></i>
            </a>
            <a href="contact.php" class="pe-md-3 pe-2 footer-text footer-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Contact Me">
